...
async def register_user(user_data : UserRegister):
    ...
    unique_token = generate_token(str(result.inserted_id), user_data.email)
    ...
    email_sender.send_email(receipient=user_data.email, email_message=message, subject_line="Please confirm your email.")
