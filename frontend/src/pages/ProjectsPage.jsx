...
const ProjectsPage = () => {
    ...
    const handleCreateSubteam = (event) => {
        ...
        alert(`Subteam "${subteamName}" created in ${selectedProject} with members: ${members}`);
                    ...
                    <li key={project.id} className="project-item">
                        ...
                        <Dialog.Root>
                            <Dialog.Trigger asChild>
                                <button className="Button violet" onClick={() => setSelectedProject(project.name)}>
                                    Create Subteam
                                </button>
                            </Dialog.Trigger>
                            <Dialog.Portal>
                                ...
                                <Dialog.Content className="DialogContent">
                                    ...
                                    <Dialog.Description className="DialogDescription">
                                        Create a subteam for <b>{selectedProject}</b>.
                                    </Dialog.Description>
